...
from qupulse.hardware.awgs.old_tabor import TaborProgram, TaborAWGRepresentation, TaborProgramMemory
from qupulse._program.tabor import TableDescription, TimeType, TableEntry
ffrom tests.hardware.dummy_modules import import_package
